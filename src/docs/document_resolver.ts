...
import YamahaSystemParameters from '../../docs/Yamaha system parameters.md';
import GeneralManual from '../../docs/General manual.md';

export enum DocPages {
    GeneralManualDocument = 'general_manual',
...
export function getDocumentById(id: string): string {
    switch (id) {
        case DocPages.GeneralManualDocument:
